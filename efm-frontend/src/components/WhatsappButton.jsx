...
function WhatsAppButton() {
  // 🚀 CUSTOM ADMIN WHATSAPP MESSAGE SPECIFICATION
  const buildAdminWhatsAppLink = () => {
    const adminPhone = "254799708228"; // 👈 REPLACE THIS with your actual WhatsApp phone number
    const message = encodeURIComponent(
      "Hello Admin! I'm a manager on EFM-PRO and I need assistance with a league match / tournament issue. ⚽🔥"
    );
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group">
      ...
      */}
      ...
      {/* Floating WhatsApp Action Anchor Link Button */}
      <a
        href={buildAdminWhatsAppLink()}
        target="_blank"
        rel="noopener noreferrer"
        className="w-14 h-14 bg-[#25D366] hover:bg-[#1da851] text-white rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/20 transition-all hover:scale-110 active:scale-95 animate-bounce"
